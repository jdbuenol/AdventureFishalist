...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light"><a href="{{ route('admin.index') }}"><img class="logo" src="{{ asset('/images/logo.png') }}"></a></div>
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{ route('admin.speciesLocations')}}">Species Locations</a>
            </div>
        </div>
